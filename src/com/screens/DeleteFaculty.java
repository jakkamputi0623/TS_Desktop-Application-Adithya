		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteFaculty.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=FacultyDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteFaculty.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteFaculty.this,"Unable to delete given id!");
					}
				}
			}
		});
